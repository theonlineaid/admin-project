...
export default function RootLayout({
  ...
  return (
    <html lang="en" dir="ltr" data-density="default" suppressHydrationWarning>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){var t=localStorage.getItem('dashboard-theme')||'emerald';var m=localStorage.getItem('dashboard-mode')||'light';var f=parseInt(localStorage.getItem('dashboard-font-size'),10);var s=(!isNaN(f)&&f>=12&&f<=22)?f:16;var ff=localStorage.getItem('dashboard-font-family')||'geist';var ffMap={geist:'var(--font-geist-sans), system-ui, sans-serif',inter:"'Inter', system-ui, sans-serif",public_sans:"'Public Sans', system-ui, sans-serif",dm_sans:"'DM Sans', system-ui, sans-serif"};var dir=localStorage.getItem('dashboard-direction')||'ltr';var density=localStorage.getItem('dashboard-density')||'default';document.documentElement.setAttribute('data-theme',t);document.documentElement.style.setProperty('--user-font-size',String(s));document.documentElement.style.setProperty('--user-font-family',ffMap[ff]||ffMap.geist);document.documentElement.setAttribute('dir',dir==='rtl'?'rtl':'ltr');document.documentElement.setAttribute('data-density',density==='compact'?'compact':'default');if(m==='dark')document.documentElement.classList.add('dark');else document.documentElement.classList.remove('dark');})();`,
          }}
        />
      </head>
      <body
